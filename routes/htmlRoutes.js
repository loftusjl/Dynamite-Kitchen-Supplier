...
module.exports = function (app) {
	...
	app.get('/order', function (req, res) {
		sequelize.query('SELECT prodID, prodName, prodPAR, prodOnHand, olQuantity, olUnitofIssue, prodPrice, SUM(prodPrice*olQuantity) AS Total, usName FROM products, orderlines, users WHERE products.id = prodID AND OrderId IS NULL AND UserId=users.id GROUP BY orderlines.id')
			.then(dbOrderline => {
